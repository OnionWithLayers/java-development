...
public class Main {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    displayAllCategories(basicDataSource);
                    break;
                case 0:
    ...
    private static void displayAllCategories(BasicDataSource basicDataSource) {
    ...
    private static void displayAllProducts(BasicDataSource basicDataSource) {
    ...
    private static void displayAllCustomers(BasicDataSource basicDataSource) {
